...
def home(request):
	...
	mutual_information['table_data'] = [
		(
			...
			mutual_information['overall1000'][0][i] if i < 4 and 0 < len(mutual_information['overall1000']) else print('1000'),
			mutual_information['overall1000'][1][i] if i < 4 and 1 < len(mutual_information['overall1000']) else print('1000'),
			mutual_information['overall1000'][2][i] if i < 4 and 2 < len(mutual_information['overall1000']) else print('1000'),
			mutual_information['overall0100'][0][i] if i < 4 and 0 < len(mutual_information['overall0100']) else print('0100'),
			mutual_information['overall0100'][1][i] if i < 4 and 1 < len(mutual_information['overall0100']) else print('0100'),
			mutual_information['overall0100'][2][i] if i < 4 and 2 < len(mutual_information['overall0100']) else print('0100'),
			mutual_information['overall1100'][0][i] if i < 4 and 0 < len(mutual_information['overall1100']) else print('1100'),
			mutual_information['overall1100'][1][i] if i < 4 and 1 < len(mutual_information['overall1100']) else print('1100'),
			mutual_information['overall1100'][2][i] if i < 4 and 2 < len(mutual_information['overall1100']) else print('1100'),
			mutual_information['overall0010'][0][i] if i < 4 and 0 < len(mutual_information['overall0010']) else print('0010'),
			mutual_information['overall0010'][1][i] if i < 4 and 1 < len(mutual_information['overall0010']) else print('0010'),
			mutual_information['overall0010'][2][i] if i < 4 and 2 < len(mutual_information['overall0010']) else print('0010'),
			mutual_information['overall1010'][0][i] if i < 4 and 0 < len(mutual_information['overall1010']) else print('1010'),
			mutual_information['overall1010'][1][i] if i < 4 and 1 < len(mutual_information['overall1010']) else print('1010'),
			mutual_information['overall1010'][2][i] if i < 4 and 2 < len(mutual_information['overall1010']) else print('1010'),
			mutual_information['overall0110'][0][i] if i < 4 and 0 < len(mutual_information['overall0110']) else print('0110'),
			mutual_information['overall0110'][1][i] if i < 4 and 1 < len(mutual_information['overall0110']) else print('0110'),
			mutual_information['overall0110'][2][i] if i < 4 and 2 < len(mutual_information['overall0110']) else print('0110'),
			mutual_information['overall1110'][0][i] if i < 4 and 0 < len(mutual_information['overall1110']) else print('1110'),
			mutual_information['overall1110'][1][i] if i < 4 and 1 < len(mutual_information['overall1110']) else print('1110'),
			mutual_information['overall1110'][2][i] if i < 4 and 2 < len(mutual_information['overall1110']) else print('1110'),
			mutual_information['overall0001'][0][i] if i < 4 and 0 < len(mutual_information['overall0001']) else print('0001'),
			mutual_information['overall0001'][1][i] if i < 4 and 1 < len(mutual_information['overall0001']) else print('0001'),
			mutual_information['overall0001'][2][i] if i < 4 and 2 < len(mutual_information['overall0001']) else print('0001'),
			mutual_information['overall1001'][0][i] if i < 4 and 0 < len(mutual_information['overall1001']) else print('1001'),
			mutual_information['overall1001'][1][i] if i < 4 and 1 < len(mutual_information['overall1001']) else print('1001'),
			mutual_information['overall1001'][2][i] if i < 4 and 2 < len(mutual_information['overall1001']) else print('1001'),
			mutual_information['overall0101'][0][i] if i < 4 and 0 < len(mutual_information['overall0101']) else print('0101'),
			mutual_information['overall0101'][1][i] if i < 4 and 1 < len(mutual_information['overall0101']) else print('0101'),
			mutual_information['overall0101'][2][i] if i < 4 and 2 < len(mutual_information['overall0101']) else print('0101'),
			mutual_information['overall1101'][0][i] if i < 4 and 0 < len(mutual_information['overall1101']) else print('1101'),
			mutual_information['overall1101'][1][i] if i < 4 and 1 < len(mutual_information['overall1101']) else print('1101'),
			mutual_information['overall1101'][2][i] if i < 4 and 2 < len(mutual_information['overall1101']) else print('1101'),
			mutual_information['overall0011'][0][i] if i < 4 and 0 < len(mutual_information['overall0011']) else print('0011'),
			mutual_information['overall0011'][1][i] if i < 4 and 1 < len(mutual_information['overall0011']) else print('0011'),
			mutual_information['overall0011'][2][i] if i < 4 and 2 < len(mutual_information['overall0011']) else print('0011'),
			mutual_information['overall1011'][0][i] if i < 4 and 0 < len(mutual_information['overall1011']) else print('1011'),
			mutual_information['overall1011'][1][i] if i < 4 and 1 < len(mutual_information['overall1011']) else print('1011'),
			mutual_information['overall1011'][2][i] if i < 4 and 2 < len(mutual_information['overall1011']) else print('1011'),
			mutual_information['overall0111'][0][i] if i < 4 and 0 < len(mutual_information['overall0111']) else print('0111'),
			mutual_information['overall0111'][1][i] if i < 4 and 1 < len(mutual_information['overall0111']) else print('0111'),
			mutual_information['overall0111'][2][i] if i < 4 and 2 < len(mutual_information['overall0111']) else print('0111'),
			mutual_information['overall1111'][0][i] if i < 4 and 0 < len(mutual_information['overall1111']) else print('1111'),
			mutual_information['overall1111'][1][i] if i < 4 and 1 < len(mutual_information['overall1111']) else print('1111'),
			mutual_information['overall1111'][2][i] if i < 4 and 2 < len(mutual_information['overall1111']) else print('1111'),
		)
